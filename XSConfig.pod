...
=head1 How to Mock a Config value?

C<%Config> is now truly readonly. But some tests require to
temporarily write a Config value. Use L<Mock::Config> from CPAN to do
that.
