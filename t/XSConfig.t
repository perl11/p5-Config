...
config_heavy    d_acosh d_asctime64 d_asinh d_atanh d_attribute_deprecated
d_backtrace d_builtin_arith_overflow    d_builtin_choose_expr
d_builtin_expect    d_c99_variadic_macros   d_cbrt  d_copysign  d_cplusplus
d_ctermid   d_ctime64   d_difftime64    d_dir_dd_fd d_dladdr    d_erf   d_erfc
d_exp2  d_expm1 d_fdim  d_fegetround    d_fma   d_fmax  d_fmin  d_fp_classify
...
d_log2  d_logb  d_lrint d_lrintl    d_lround    d_lroundl   d_mktime64  d_nan
d_ndbm  d_ndbm_h_uses_prototypes    d_nearbyint d_nextafter d_nexttoward
d_prctl d_prctl_set_name    d_printf_format_null    d_pseudofork    d_ptrdiff_t
...
d_statvfs   d_tgamma    d_timegm    d_trunc d_truncl    d_ustat
...
i_ustat ieeefp_h    initialinstalllocation  ldflags_nolargefiles
...
userelocatableinc   usesfio vaproto voidflags
      );
  }
  for my $k (@cannedkeys) {
    $Config_copy{$k} = '' unless exists $Config{$k};
